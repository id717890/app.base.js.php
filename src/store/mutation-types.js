...
/* Gift */
export const RECIEVE_WINNERS = 'RECIEVE_WINNERS'
export const RECIEVE_GIFTS_FOR_ADMIN = 'RECIEVE_GIFTS_FOR_ADMIN'

/* Gift Draw */
export const RESET_RANDOMIZER = 'RESET_RANDOMIZER'
export const SET_RANDOMIZER_GIFT_DRAW_BUSY = 'SET_RANDOMIZER_GIFT_DRAW_BUSY'
export const RECIEVE_GIFT_DRAW_KEYS_AND_RANDOM = 'RECIEVE_GIFT_DRAW_KEYS_AND_RANDOM'
export const RECIEVE_GIFT_DRAWS_FOR_ADMIN = 'RECIEVE_GIFT_DRAWS_FOR_ADMIN'
