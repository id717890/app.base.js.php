  ...
  routes: [
    {
      ...
      children: [
        ...
        { path: 'feedbacks', name: 'UserFeedbacks', components: { routerguest: () => import('../components/Public/Feedback/Index.vue') } },
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'feedbacks', name: 'Feedbacks', beforeEnter: authGuard, components: { routeradmin: () => import('../components/Private/Admin/Feedback/Index.vue') } },
