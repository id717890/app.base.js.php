<template>
  <v-carousel  height="450" class="feedback3" style="border: 1px solid blue">
    <v-carousel-item>
      <v-layout row>
        <v-flex xs4 pt-4 text-xs-center>
          <v-card max-width="330" :color="feedbacks[0].color" class="elevation-5 product feedback" >
            <v-card-title>
              <v-list-tile>
                <v-list-tile-avatar class="avatar1">
                  <v-img class="elevation-6" :src="feedbacks[0].img"></v-img>
                </v-list-tile-avatar>
              </v-list-tile>
            </v-card-title>
            <v-card-text>
    ...
    <v-carousel-item>
      <v-layout row>
        <v-flex xs4 offset-xs1 pt-4 text-xs-center>
          <v-card max-width="330" :color="feedbacks[0].color" class="elevation-5 product feedback" >
            <v-card-title>
              <v-list-tile>
                <v-list-tile-avatar class="avatar1">
        ...
        <v-flex xs4 offset-xs2 pt-4 text-xs-center>
          <v-card max-width="330" :color="feedbacks[0].color" class="elevation-5 product feedback" >
            <v-card-title>
              <v-list-tile>
                <v-list-tile-avatar class="avatar1">
